        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              Instalação Anterior do Meetily Detectada!
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            Encontramos um banco de dados existente da sua instalação anterior do Meetily (versão com backend Python).
          </p>
          <div className="bg-white/50 rounded p-2 mb-3">
            ...
            <p className="text-xs text-blue-600 mt-1">
              Tamanho: {formatFileSize(dbSize)}
            </p>
          </div>
          <p className="text-sm text-blue-800 mb-3">
            Deseja importar suas reuniões, transcrições e resumos anteriores?
          </p>
