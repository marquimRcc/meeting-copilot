      ...
      <div className="flex items-start justify-between w-full">
        <div className="flex-1">
          <AlertTitle className="text-yellow-900 font-semibold">
            Reprodução via Bluetooth Detectada
          </AlertTitle>
          <AlertDescription className="text-yellow-800 mt-1">
            Você está usando <strong>{deviceName}</strong> para reprodução.
            As gravações podem soar distorcidas ou aceleradas em dispositivos Bluetooth.
            Para uma reprodução fiel, utilize os <strong>alto-falantes do computador</strong> ou{' '}
            <strong>fones de ouvido com fio</strong>.
            <br />
            <a
