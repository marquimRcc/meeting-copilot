  ...
  return (
    <>
      <div className="space-y-4">
        <div>
          <h3 className="text-base font-semibold text-gray-800 mb-2">Telemetria de Uso</h3>
          <p className="text-sm text-gray-600 mb-4">
            A telemetria de uso fica desativada por padrão. Você pode ativá-la para compartilhar dados anônimos de desempenho e produto; nenhum conteúdo pessoal é coletado.
          </p>
        </div>

        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
          <div>
            <h4 className="font-semibold text-gray-800">Ativar Telemetria</h4>
            <p className="text-sm text-gray-600">
              {isProcessing ? 'Atualizando...' : 'Desativada a menos que você escolha ativá-la'}
            </p>
          </div>
          ...
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <div className="font-medium text-gray-800 mb-1">Seu ID de Usuário</div>
                <p className="text-xs text-gray-600 mb-2">
                  Compartilhe este ID ao relatar problemas para nos ajudar a investigar os logs
                </p>
        ...
        <div className="flex items-start gap-2 p-2 bg-blue-50 rounded border border-blue-200">
          ...
          <div className="text-xs text-blue-700">
            <p className="mb-1">
              Suas reuniões, transcrições e gravações permanecem completamente privadas e locais.
            </p>
            <button
