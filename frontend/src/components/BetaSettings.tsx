    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        ...
        <div className="text-sm text-yellow-800">
          <p className="font-medium">Recursos Beta</p>
          <p className="mt-1">
            Estes recursos ainda estão sendo testados. Você pode encontrar instabilidades, e seu feedback é muito bem-vindo.
          </p>
        </div>
      </div>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Observação:</strong> Quando desativados, os recursos beta ficarão ocultos. Suas reuniões existentes não serão afetadas.
        </p>
      </div>
    </div>
  );
