...
export const BETA_FEATURE_NAMES: Record<keyof BetaFeatures, string> = {
  importAndRetranscribe: 'Importar Áudio & Retranscrever',
};
...
export const BETA_FEATURE_DESCRIPTIONS: Record<keyof BetaFeatures, string> = {
  importAndRetranscribe: 'Importe arquivos de áudio para transcrever ou retranscreva reuniões existentes com diferentes configurações de idioma.',
};
